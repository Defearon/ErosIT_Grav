...
class __TwigTemplate_4f9e79bc1a163594e19b377a72996388924270944c7347640bcf0dcf5c5b2078 extends \Twig\Template
{
...
";
    ...
    ";
        // line 31
        echo "    ";
        $context["highlight"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFilter($this->getAttribute(($context["field"] ?? null), "highlight", []));
        // line 32
        echo "    ";
        $context["value"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFilter((($context["value"]) ?? ((($context["default"]) ?? (($context["highlight"] ?? null))))));
        // line 33
        echo "
    ";
        // line 34
        ...
        foreach ($context['_seq'] as $context["key"] => $context["text"]) {
            // line 35
            echo "      ";
            $context["key"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->stringFilter($context["key"]);
            // line 36
            echo "      ";
...
{% endblock %}
", "forms/fields/toggle/toggle.html.twig", "D:\\git\\ErosIT_Grav\\user\\plugins\\form\\templates\\forms\\fields\\toggle\\toggle.html.twig");
    }
}
